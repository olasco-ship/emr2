...
if(is_post()){
    ...
    if ((!$errorMessage) and empty($errorMessage)){
        ...
        $productType->sync = "off";
        $productType->name = $name;
        $productType->created = strftime("%Y-%m-%d %H:%M:%S", time());
        if ($productType->create()){
            $done = TRUE;
            $session->message("A new Product Type has been created.");
            redirect_to('index.php');
        } else {
            $done = FALSE;
            $session->message("Could not create a new Drug Type.");
                            ...
                            <div class="card">
                                <div class="body">
                                    <ul class="nav nav-tabs-new">
                                        ...
                                        <li class="nav-item"><a class="nav-link" data-toggle="tab" href="#Profile-new">Add New Type</a></li>
                                    </ul>
                                    <div class="tab-content">
                                        <div class="tab-pane show active" id="Home-new">
                                            <h3 class="heading">Type Of Drugs</h3>
                                        ...
                                        <div class="tab-pane" id="Profile-new">
                                            <h3 class="heading"> Add New Type Of Drug</h3>
                                            <form action="" method="post">

                                                <div class="col-md-6">
                                                    <div class="input-group">
                                                        <input class="form-control" name="name" placeholder="Type Name" style="width: 300px"
                                                               type="text">
