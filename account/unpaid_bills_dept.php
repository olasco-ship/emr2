            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <h4> All Unpaid Bills By Department </h4>
                        ...
                        //    $bills = Bill::find_unpaid_bills_btw_date($startDate, $endDate);
                            $bills = Bill::find_unpaid_bills_dept_btw_date($department, $startDate, $endDate);
                            if (empty($bills)) {  ?>
                                <div class="alert alert-info alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    No Unpaid bills pending between this period
                                </div>
                            <?php  } else {  ?>
                                <div class="alert alert-success alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    All Unpaid bills generated between <?php echo $start_date . " and " . $end_date ?>
                                </div>
                            <?php  } ?>
                            <div class="card">
                                <div class="body">
