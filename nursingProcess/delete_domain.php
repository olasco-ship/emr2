...
if(is_post()){
    ...
    if ($finds->delete()){
        $session->message("The Nursing Domain has been deleted.");
        redirect_to('index.php');
    } else {
        $session->message("Could not delete the Nursing Domain .");
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane show active" id="Home-new">
                                                ...
                                                <form id="basic-form" action="" method="post">
                                                    ...
                                                    <br>
                                                    <button type="submit" class="btn btn-primary">Delete Domain</button>
                                                </form>
