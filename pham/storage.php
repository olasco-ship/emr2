                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pham/add_stock.php">
                                ...
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pham/stock_history.php">
                                ...
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pham/index.php">
                                        <div class="body bg-success text-light">
                                            <h4><i class="icon-wallet"></i> <?php // echo $count
                                                ?> </h4>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pham/station.php">
                                ...
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pham/flow_one.php">
                                ...
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pham/history.php">
                                        <div class="body bg-warning text-light">
                                            <h4><i class="icon-wallet"></i><!-- 25,965$-->
                                            </h4>
                                            <span> Drugs Assigned History </span>
                                        </div>
                                    </a>
                                </div>
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-md-3">
                                    <a href="../pharm_reports/index.php">
                                        <div class="body bg-dark text-light">
                                            <h4><i class="icon-wallet"></i>
                                            </h4>
                                            <span>  Reports </span>
