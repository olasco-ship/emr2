                                ...
                                <div class="tab-pane table-responsive active show" id="All">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        <tr>
                                            ...
                                            <th>Consultant</th>
                                            <th>Gender</th>
                                            <th>Investigation(s) Required </th>
                                            <th>Status</th>
                                        ...
                                        if (is_post()) {
                                            ...
                                            foreach($bills as $bill) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $encounter->consultant ?></td>
                                                    <td><?php echo $patient->gender ?></td>
                                                    <td>
<!--                                                        --><?php /*$encounter = Encounter::find_by_id($bill->encounter_id); $testRequest = TestRequest::find_paid_bill($encounter->id);
                                                        foreach ($testRequest as $r) echo $r->test_name . ','; */?>
                                                    </td>
