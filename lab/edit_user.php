                            ...
                            <div class="tab-pane" id="modify">
                                ...
                                <form id="basic-form" method="post" action="">
                                    <div class="card">
                                        ...
                                        <div class="body">
                                            <h5><a href="scientists.php" style="..."> &laquo; Back </a></h5>
                                            <h4>Basic Details </h4>
                                            <div class="row clearfix">
                                                ...
                                                <div class="col-sm-6">
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control"  name="unit">
                                                            <option value=""></option>
                                                            <option <?php echo ($usr->unit == 'Haematology') ? 'selected ="TRUE"' : ''; ?>
                                                                    value="Haematology">Haematology
                                                            </option>
                                                            <option <?php echo ($usr->unit == 'Chemical Pathology') ? 'selected ="TRUE"' : ''; ?>
                                                                    value="Chemical Pathology">Chemical Pathology
                                                            </option>
                                                            <option <?php echo ($usr->unit == 'Microbiology') ? 'selected ="TRUE"' : ''; ?>
                                                                    value="Microbiology">Microbiology
                                                            </option>
                                                            <option <?php echo ($usr->unit == 'Histology') ? 'selected ="TRUE"' : ''; ?>
                                                                    value="Histology">Histology
                                                            </option>
<!--                                                            <option --><?php //echo ($usr->unit == 'Nuclear Medicine') ? 'selected ="TRUE"' : ''; ?>
<!--                                                                    value="Nuclear Medicine">Nuclear Medicine-->
<!--                                                            </option>-->
                                                        </select>
                                                    </div>
                                                </div>
