                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>
                             Preliminary Laboratory Result </h2>
                        <ul class="breadcrumb">
                        ...
                        <div class="body">
                           ...
                           <!-- <form class="form-inline" id="basic-form" action="" method="post">
                            ...
                            <ul class="nav nav-tabs-new2">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#All">Preliminary Laboratory Results</a></li>
                            </ul>
                                        ...
                                        <?php
                                           /* if (is_post()){*/
                                              //  $dept = test_input($_POST['department']);
                                                $dept   = $user->unit;
                                                $results = Result::find_all_prelim_checked_by_dept($dept);
