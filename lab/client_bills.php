...
$services = LabServices::find_billed();




$walk_in = LabWalkIn::find_request();
                            ...
                            <div class="tab-content m-t-10 padding-0">
                                <div class="tab-pane table-responsive active show" id="All">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        <?php  foreach($walk_in as $walk) { 
                                            $bill = Bill::find_by_id($walk->bill_id);
                                            ?>
                                            <tr>                                          
                                                <td><a href="walk_in_bill.php?id=<?php echo $bill->id ?>"><?php echo $bill->bill_number ?></a></td>
