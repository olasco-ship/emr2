                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>
                             Laboratory Result Pending Quality Control </h2>
                        <ul class="breadcrumb">
                        ...
                        <div class="body">
                           ...
                           <!-- <form class="form-inline" id="basic-form" action="" method="post">
                            ...
                            <ul class="nav nav-tabs-new2">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#All">Laboratory Results</a></li>
                            </ul>
                                    ...
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        <?php
                                              ...
                                              //  $results = Result::find_all_by_status_and_dept($status, $dept);
                                                $results = Result::find_all_pending_qc_by_dept($dept);
                                                    ...
                                                    switch ($dept) {
                                                        case 'Haematology':
                                                            if ($result->unit == 'Haematology') {
                                                                if (!empty($patient)) {
                                                                    echo  "<td><a href='haem_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                                } else {
                                                                    echo  "<td><a href='haem_check.php?id=$result->id'> NA </a></td>";
                                                                }
                                                            }else if ($result->unit == 'Blood Transfusion'){
                                                                if (!empty($patient)) {
                                                                    echo  "<td><a href='blood_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                                } else {
                                                                    echo  "<td><a href='blood_check.php?id=$result->id'> NA </a></td>";
                                                                }
                                                            }
                                                      //  echo  "<td><a href='haem_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                             break;
                                                        ...
                                                        case 'Chemical Pathology':
                                                            if (!empty($patient)) {
                                                                echo  "<td><a href='chem_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                            } else {
                                                                echo  "<td><a href='chem_check.php?id=$result->id'> NA </a></td>";
                                                            }
                                                          //  echo  "<td><a href='chem_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                              break;
                                                        case 'Microbiology':
                                                            if ($result->unit == 'Microbiology') {
                                                                if (!empty($patient)) {
                                                                    echo  "<td><a href='micro_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                                } else {
                                                                    echo  "<td><a href='micro_check.php?id=$result->id'> NA </a></td>";
                                                                }
                                                            }else if ($result->unit == 'Parasitology'){
                                                                if (!empty($patient)) {
                                                                    echo  "<td><a href='para_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                                } else {
                                                                    echo  "<td><a href='para_check.php?id=$result->id'> NA </a></td>";
                                                                }
                                                            }
                                                          //  echo  "<td><a href='micro_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                            break;
                                                        ...
                                                        case 'Histology':
                                                            if (!empty($patient)) {
                                                                echo  "<td><a href='histo_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                            } else {
                                                                echo  "<td><a href='histo_check.php?id=$result->id'> NA </a></td>";
                                                            }
                                                          //  echo  "<td><a href='histo_check.php?id=$result->id'> $patient->folder_number </a></td>";
                                                            break;
                                                        default:
...
/*                                            else {
                                        $results = Result::find_all_pending_qc();
                                        foreach($results as $result) {
                                            $bill = Bill::find_by_id($result->bill_id);
                                            $patient = Patient::find_by_id($result->patient_id);*/
                                            ?>
