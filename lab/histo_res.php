...
if (is_post()){
    ...
    if (isset($_POST['save_only'])) {
        ...
        $processing      = $_POST['microtomy'];
        $microtomy       = $_POST['Microtomy'];
        $he              = $_POST['H & E'];
        $special_stain   = $_POST['Special Stain'];

        $histo                       = new stdClass();
        $histo->Microtomy           = $processing;
        $histo->HE                   = $he;
        $histo->SpecialStain         = $special_stain;
                    ...
                    <div class="card patients-list">
                        ...
                        <div class="body">
                            <div class="container">
                                ...
                                <?php  include("../labResults/histo_res.php"); ?>
