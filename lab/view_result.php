                ...
                <div class="col-md-12">
                    <div class="card patients-list">
                        ...
                        <div class="body">
                            ...
                            <h4 class="section-title"><i class="fa fa-pie-chart"></i> Laboratory Results for
                                <?php
                                    ...
                                    <div class="table-responsive">
                                        ...
                                        <table>
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <td colspan="3" style="text-align: center"><h4>HAEMATOLOGY</h4></td>
                                                </tr>
                                        ...
                                        <table>
                                            <table class="table table-bordered">
                                                <tr>
                                                    <td colspan="3" style="text-align: center"><h4>CHEMICAL PATHOLOGY</h4></td>
                                                </tr>
