...
if (is_post()) {
        ...
        $foo->MCHC         = $mchc;
        $foo->WBC          = $wbc;
        $foo->Platelets    = $platelets;
        $foo->Retics       = $retics;
        $foo->ESR          = $esr;
        $foo->NEUT         = $neutophils;
        $foo->LYMPH        = $lymphocytes;
        $foo->MONO         = $monocytes;
        $foo->Eosino       = $eosinophlis;
        $foo->BASO         = $basophils;
        $foo->Normo        = $normo;
        $foo->BleedingTime = $bleeding_time;
        $foo->ClottingTime = $clotting_time;
        $foo->PT           = $pt;
        $foo->PTT          = $ptt;
        $foo->APTT         = $aptt;
        $foo->HBsAg        = $hbsagb;
        $foo->HCV          = $hcv;
        $foo->RvsScreening = $rvs_screening;
        $foo->VDRL         = $vdrl;
        $foo->MP           = $malaria_parasite;
        $foo->Others       = $others;
        $foo->CoombsTest   = $coombs_test;
        $foo->IndCoombsTest= $ind_coombs_test;
        $foo->CD4          = $cd4;
        $foo->BloodGroup   = $blood_group;
        $foo->HbGenotype   = $hb_genotype;
        $foo->G6PD         = $_POST['g6pd'];
        $foo->BoneMarrow   = $bone_marrow;
        $foo->Notes        = $notes;
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <table class="table table">
                                                ...
                                                <tr class="active">
                                                    <th>Lab No.</th>
                                                  <!--    <td> <?php echo $result->resultData ?> </td> -->
                                                        ...
                                                        <div class="table-responsive" >
                                                            ...
                                                            <table class="table table-bordered">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="2"><input class="form-control" name="ind_coombs_test" value="<?php echo $coombs_test; ?>" type="text"></td>
                                                                </tr>
