                                ...
                                <table class="table m-b-0 table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (is_post()) {
                                            ...
                                            $testRequests = TestRequest::find_awaiting_costing();
                                            ...
                                            ?>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php $d_date = date('d/m/Y h:i:a', strtotime($request->date));
                                                        echo $d_date ?></td>

                                                    <td><?php if ($request->ward_id == 0) {  ?>

                                                            <a href='cost_test.php?id=<?php echo $request->id ?>'>Cost</a>
                                                        <?php   } else {  ?>
                                                            <div class="btn-group" role="group">
                                                                ...
                                                                <div class="dropdown-menu" aria-labelledby="btnGroupDrop1">
                                                                    <a class="dropdown-item" href='cost_test.php?id=<?php echo $request->id ?>'>Cash</a>
                                                                    <a class="dropdown-item" href='cost_ward_test.php?id=<?php echo $request->id ?>'>Pay From Wallet</a>
                                                                </div>
                                                            </div>
