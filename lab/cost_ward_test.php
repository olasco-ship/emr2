...
$admission   = ReferAdmission::find_by_patient($testRequest->patient_id);
...
if (is_post()) {
    ...
    if (isset($_POST['generate_bill'])) {
        ...
        $newAccountHistory->patient_id       = $testRequest->patient_id;
