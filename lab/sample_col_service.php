                                ...
                                <table class="table m-b-0 table-hover">
                                    ...
                                    <tbody>
                                        ...
                                        if (is_post()) {
                                            ...
                                            $services = LabServices::find_cleared();
                                            foreach ($services as $service) {
                                                $bill        = Bill::find_by_id($service->bill_id);
                                                $testRequest = TestRequest::find_by_id($service->test_request_id);
                                                $patient     = Patient::find_by_id($testRequest->patient_id);
                                            ?>
                                                <tr>
                                                    <td><a href='collect_service.php?id=<?php echo $service->id  ?>'>
                                                            <?php
                                                            if (!empty($patient)) {
                                                    ...
                                                    <td><?php
                                                        if (!empty($patient)) {
                                                            ...
                                                            $labWalk = LabWalkIn::find_by_id($testRequest->labWalkIn_id);
