...
if (is_post()) {
    ...
    if (isset($_POST['send_result'])) {
        ...
        $result->qc_date            = strftime("%Y-%m-%d %H:%M:%S", time());
        $result->save();
        $session->message("Result has been sent to laboratory.");
        redirect_to('results.php');
    }
}
                ...
                <div class="col-md-12">
                    <div class="card patients-list">
                        ...
                        <div class="body">
                            ...
                            <?php // include("../labResults/chem_res.php");
                            ...
                            <form action="" method="post">
                                ...
                                <p class="margin-top-30">
                                    ...
                                    <button type="submit" name="back_result" class="btn btn-lg btn-danger"> Send Result Back to Lab </button>
                                </p>
