                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-8 col-sm-6">
                                ...
                                <div id="body">
                                    ...
                                    <a style="font-size: larger" href="../rad/cost.php">&laquo;Back</a>
                                    <div id="body">
                                        ...
                                        <table class="table table-bordered table-condensed table-hover">
                                            ...
                                            <?php
                                            if (!empty(ScanRequest::find_costed_bill_dept($bill->id))) {
                                                $scans = ScanRequest::find_costed_bill_dept($bill->id);

                                                $rad_Service = RadioServices::find_by_bill_id($bill->id);
                                                $decode = json_decode($rad_Service->services);
                                            //    $eachScan = EachScan::find_all_costed($scans->id);
                                              
                                                foreach ($decode as $each) {
                                                  //  $eachTest = EachTest::find_by_name_and_request_id($each, $tests->id);
                                                    $eachScan = EachScan::find_by_name_and_request_id($each, $scans->id);
                                                        $test = Test::find_by_id($eachScan->scan_id);
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $each; ?></td>
                                                        <td><?php echo "₦$eachScan->scan_price";    ?></td>
                                                        <td> <?php echo $eachScan->quantity; ?></td>
                                                        <td><?php $y = $eachScan->scan_price * $eachScan->quantity;
