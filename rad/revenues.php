                    ...
                    <div class="card patients-list">
                        <div class="body">
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    <div class="body">
                                        <a href="../rad/home.php" style="font-size: large">&laquo; Back</a>
...
/*                                                            }
                                                    ...
                                                    <input class="form-control" name="revenueHead_id" value="3" hidden>
