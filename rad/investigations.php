                                ...
                                <div class="tab-pane table-responsive active show" id="All">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        if (is_post()) {
                                            ...
                                            $bills = Bill::find_all_by_dept_and_paid($dept);
                                            foreach($bills as $bill) {
                                                ...
                                                ?>
                                                <tr>
                                                    <td><a href='form.php?id=<?php echo $bill->id ?>'><?php echo $patient->folder_number ?></a></td>
