...
$bills = Bill::find_waiting_consultation();
        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Patient Re-visit</h2>
                    <ul class="breadcrumb">
                                    ...
                                    <?php foreach ($bills as $bill) {   ?>
                                        <tr>
                                            ...
                                            <td><?php $d_date = date('d/m/Y h:i a', strtotime($bill->date));
                                                echo $d_date ?></td>
                                            <td><a href="visit_clinic.php?id=<?php echo $bill->id ?>"><?php echo $bill->receipt ?></a></td>
