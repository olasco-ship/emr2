                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>
                            Coding and Indexing </h2>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.php"><i class="icon-home"></i></a></li>
                            <li class="breadcrumb-item">Coding and Indexing</li>
                            <li class="breadcrumb-item active">Uncoded Diagnosis</li>
                        </ul>
                    </div>
                    ...
                    <div class="card patients-list">
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs-new2">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#PendingAdmission"> Uncoded Diagnosis </a></li>
                            </ul>
                            ...
                            <div class="tab-content m-t-10 padding-0">
                                ...
                                <div class="tab-pane table-responsive active show" id="PendingAdmission">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        $todayVisit = WaitingList::find_all_pending_icd();
                                        ...
                                        foreach ($todayVisit as $visit) {
                                            ...
                                            <tr>
                                                ...
                                                <td><a href='attach_code.php?id=<?php echo $visit->id ?>'><?php echo $patient->folder_number ?></a></td>
                                                <td><?php echo $patient->full_name()  ?></td>
                                                <td><?php echo $subClinic->name ?></td>
                                                <td><?php echo $visit->dr_seen  ?> </td>
                                                <td><?php $d_date = date('d/m/Y', strtotime($visit->date)); echo $d_date ?></td>
                                            </tr>
