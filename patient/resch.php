...
/*    $app_date = new DateTime($_POST['app_date']);
   ...
   // echo $app_date; exit;
    ...
    $app->save();
    $session->message("Appointment has been re-scheduled for this patient");
                    ...
                    <div class="card patients-list">
                        ...
                        <div class="body">
                            ...
                            <form method="post" action="">
                                ...
                                <div class="form-group">
                                    <input type="text" class="form-control" id="app_date" style="width: 300px"  placeholder="" name="app_date"
                                           value="<?php echo date_to_text($app->app_date)   ?>" required >
                                </div>
