            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    ...
                    <?php } ?>
                            ...
                            <div class="text-right"><a href="add_mapping_question.php" class="btn btn-primary"> Add Question Mapping </a></div>
                                    ...
                                    <table class="table no-margin table-dark table-striped table-hover">
                                        ...
                                        ?>
                                            <tr id="locationId<?= $find->id ?>">
                                                ...
                                                <td ><a href="javascript:void(0)"> <?= ucfirst($find->section_name) ?> </a></td>
                                                <td ><a href="javascript:void(0)"> <?= $find->age_group_to."-".$find->age_group_from ?> </a></td>
                                                <td>
                                                <?php
                                                    foreach(json_decode($find->body_part_id) as $d){
                                                        $bodyType = BodyPart::find_by_id($d);
                                                        echo $bodyType->name.", ";
                                                    }
                                                ?>
                                                </td>
                                                <td> 
                                                    <a href="edit_mapping_question.php?id=<?php echo $find->id; ?>">  <i class="fa fa-edit" title="Edit"></i> </a> 
                                                    <a href="javascript:void(0)" id="deleteLocation" onclick="deleteQuestionMapping('<?= $find->id ?>')" >  <i class="icon-trash" title="Delete"></i> </a> 
                                                </td>
                                            </tr>
                                        <?php }
                                        } ?>
