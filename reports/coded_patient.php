                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            if (is_post()) {
                                ...
                                $patient = WaitingList::find_all_icd_done_by_date($startDate, $endDate);
                                            ...
                                            <table class="table m-b-0">
                                                ...
                                                if (is_post()) {
                                                    foreach ($patient as $pat) {
                                                        ...
                                                        $code = CodedDiagnosis::find_by_id($name->id);
                                                        $code_name = ICDCode::find_by_id($code->icdCode_id);
                                                        ?>
                                                        <tr>
                                                            <td><?php echo $index++; ?></td>
                                                            <td><a href='#'><?php echo $name->folder_number ?></a></td>
