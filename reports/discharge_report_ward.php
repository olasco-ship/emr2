            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <h4> All Discharge Report By Ward </h4>
                        ...
                        if (is_post()) {
                            ...
                            $admission = ReferAdmission::find_discharge_by_date($start_date, $end_date);

                            if (empty($admission)) {  ?>
                                <div class="alert alert-info alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    No discharge patient between <?php echo $start_date . " and " . $end_date  ?>
                                </div>
                            <?php  } else {  ?>
