                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            if (is_post()) {
                                ...
                                $patient = WaitingList::find_all_icd_done_by_clinic_date($subClinic, $startDate, $endDate);
                                ...
                                if (empty($patient)) {  ?>
                                    <div class="alert alert-info alert-dismissible" role="alert" style="width: 800px">
                                        ...
                                        No folder was done between this period
                                    </div>
                                <?php  } else {  ?>
                                            ...
                                            <table class="table m-b-0">
                                                ...
                                                if (is_post()) {
                                                    foreach ($patient as $pat) {
                                                        $name = Patient::find_by_id($pat->patient_id);
                                                        $code = CodedDiagnosis::find_by_id($pat->patient_id);
                                                        $code_name = ICDCode::find_by_id($code->id);
                                                        ?>
                                                        <tr>
                                                            <td><?php echo $index++; ?></td>
                                                            <td><a href='patient_detail.php?id=<?php echo $name->id ?>'><?php echo $name->folder_number ?></a></td>
                                                            <td><?php echo $name->full_name()  ?></td>
                                                            <td><?php echo $code_name->code ?></td>
                                                            <td><?php echo $code->coded_by  ?> </td>
                                                            <td><?php $d_date = date('d/m/Y', strtotime($code->date));
                                                                echo $d_date ?></td>
                                                        </tr>
