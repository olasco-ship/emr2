            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <h4> All Pending Admission By Ward </h4>
                        ...
                        if (is_post()) {
                         ...
                         //   $admission = ReferAdmission::find_pending_admission_by_date($start_date, $end_date);
                            $admission = ReferAdmission::find_pending_admission_by_ward($ward, $start_date, $end_date);

                            if (empty($admission)) {  ?>
                                <div class="alert alert-info alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    No pending admission for <?php echo $w->ward_number ?> between <?php echo $start_date . " and " . $end_date  ?>
                                </div>
                            <?php  } else {  ?>
                                <div class="alert alert-success alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    All pending admission between <?php echo $start_date . " and " . $end_date  ?>
                                </div>
                            <?php  } ?>
                            <div class="card">
                                <div class="body">
