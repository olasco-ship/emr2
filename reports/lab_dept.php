            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <h4> All Laboratory Report By Department </h4>
                        ...
                        if (is_post()) {
                            ...
                            $results = Result::find_all_checked_by_dept_date($department, $startDate, $endDate);
                            if (empty($results)) {  ?>
                                <div class="alert alert-info alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    No Laboratory test in <?php echo $department ?> for this period
                                </div>
                            <?php  } else {  ?>
                                <div class="alert alert-success alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    All records of Laboratory test in <?php echo $department ?> between <?php echo $start_date . " and " . $end_date ?>
                                </div>
                            <?php  } ?>
                            <div class="card">
                                <div class="body">
                                    <div class="table-responsive">
                                        <table class="table m-b-0">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            <!--   <td><a href='view_result.php?id=<?php echo $result->id ?>'><?php echo $patient->folder_number ?></a></td> -->
