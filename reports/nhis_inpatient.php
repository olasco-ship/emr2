                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            if (is_post()) {
                                ...
                                $admission = ReferAdmission::find_admitted_by_date($start_date, $end_date);

                                //   $waiiting = WaitingList::find_all_done_by_clinic_date($sub_clinic_id, $startDate, $endDate);
                                if (empty($admission)) {  ?>
                                    <div class="alert alert-info alert-dismissible" role="alert" style="width: 800px">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        No patient was admitted between <?php echo $start_date . " and " . $end_date  ?>
                                    </div>
                                <?php  } else {  ?>
                                    <div class="alert alert-success alert-dismissible" role="alert" style="width: 800px">
                                        <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                        All patients admitted between <?php echo $start_date . " and " . $end_date  ?>
                                    </div>
                                <?php  } ?>
                                <div class="card">
                                    <div class="body">
                                            ...
                                            <table class="table m-b-0">
                                                ...
                                                if (is_post()) {
                                                    foreach ($admission as $adm) {
                                                        $patient     = Patient::find_nhis_number($adm->patient_id);
