                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Item Assigned History</li>
                    ...
                    <div class="card patients-list">
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs-new2">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#All"> Assigned History </a></li>
                            </ul>
                            <div class="tab-content m-t-10 padding-0">
                                <div class="tab-pane table-responsive active show" id="All">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        <tbody>
                                        <?php
                                        $history = StoreDispenseHistory::find_all_by_date();
