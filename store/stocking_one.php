    ...
    if ($newStock->save()) {
      //  $markup = 0.1;
        foreach ($new_array as $item) {
            ...
            $product                        = StockItems::find_by_name($item['product_name']);
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Assign Items</li>
                        </ul>
                    </div>
...
<!--                                                </tr>-->
                                                ...
                                                <tr>
                                                    <td colspan="8"><button type="submit" class="btn btn-success"> Save To Store </button></td>
                                                </tr>
                                            </form>
                                            </tbody>
                                        </table>
