                                    ...
                                    <div id="body">
                                        ...
                                        <table class="table table-bordered table-condensed table-hover">
                                            ...
                                            if (!empty(DrugRequest::find_costed_bill_dept($bill->id))) {
                                              ...
                                              //  echo $drug_Service->services;  exit;
                                             ...
                                             //   foreach ($eachDrug as $each) {
                                                        $eachDrug = EachDrug::find_by_name_and_request_id($each, $drugs->id);
                                                      //  $product = Product::find_by_id($each->product_id);
                                                          $product = Product::find_by_name($each);
                                                    ?>
                                                    <tr>
                                                        <td><?php echo $each;  // echo $each->product_name; ?></td>
                                                        <td><?php echo "₦$product->price";    ?></td>
                                                        <td> <?php  echo $eachDrug->quantity; // echo $each->quantity; ?></td>
                                                        <td><?php $y = $product->price * $eachDrug->quantity; // $y = $product->price * $each->quantity;
                                                            echo "₦$y";     ?></td>
                                                    </tr>
                                                <?php }     }  ?>
