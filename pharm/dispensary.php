                ...
                <div class="col-lg-12 col-md-12">
                    <div class="card">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pharm/cost.php">
                                ...
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pharm/dispense_service.php">
                                ...
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pharm/dispensed.php">                                   
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pharm/dispensary_drugs.php">
                                        <div class="body bg-success text-light">
                                ...
                                <div class="col-md-3">
                                    <a href="<?php echo emr_lucid ?>/pharm/ret.php">
