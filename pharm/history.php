                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        ...
                        <ul class="breadcrumb">
                            ...
                            <li class="breadcrumb-item">Dispensory</li>
                    ...
                    <div class="card patients-list">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs-new2">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#All"> Dispense History </a></li>
                                ...
                                <div class="tab-pane table-responsive active show" id="All">
                                    ...
                                    if (is_post()) {
                                        ...
                                        <?php } }
                                         ...
                                         $history = DispenseHistory::find_all();
