...
//                        }
                    ...
                    echo "<tr>";
                    echo "<td> <b> Procastiline </b> </td>";
                    foreach ($decode as $key => $value) {
                        if (isset($value) and !empty($value)) {
                            if ($key == 'procastiline_o') {
                                echo "<td> $value </td>";
                            }
                            if ($key == 'procastiline_h') {
                                echo "<td> $value </td>";
                            }
                        }
                    }
...
//                        if (isset($value) and !empty($value)) {
                            if ($key == 'date_col') {
                                echo "<tr>";
                                echo "<td colspan='3' style='text-align: center'> SEMEN ANALYSIS M/C/S </td>";
                                echo "</tr>";
                            }
//                        }
                    }
                    ...
                    foreach ($decode as $key => $value) {
                        if (isset($value) and !empty($value)) {
                            if ($key == 'micro_pus_cell') {
                                echo "<tr>";
                                echo "<td colspan='3' style='text-align: center'> MACROSCOPY </td>";
...
//                        if (isset($value) and !empty($value)) {
                            if ($key == 'pus_cell') {
                                echo "<tr>";
                                echo "<td colspan='3' style='text-align: center'> URINE M/C/S </td>";
...
//                        if (isset($value) and !empty($value)) {
                            if ($key == 'micro_rbc') {
                                echo "<tr>";
                                echo "<td colspan='3' style='text-align: center'> MISCELLANEOUS </td>";
...
//                        if (isset($value) and !empty($value)) {
                            if ($key == 'mip') {
                                echo "<tr>";
                                echo "<td colspan='3' style='text-align: center'> ANTI BIOTICS </td>";
                                echo "<tr>";
//                            }
                        }
                    }
                    ...
                    $result->anti_one;
                    $anti_one  = json_decode($result->anti_one);
                    foreach ($anti_one as $key => $value) {
                        if (isset($value) and !empty($value)) {
                                echo "<tr>";
                                echo "<td><b> $value->antibiotics </b></td>";
                                echo "<td colspan='2' style='text-align: center'>$value->resultA $value->resultB $value->resultC $value->resultD</td>";
                                echo "</tr>";
                        }
                    }
...
//                        }
                    ...
                    foreach ($decode as $key => $value) {
                        if (isset($value) and !empty($value)) {
                            if ($key == 'bloodCulture_microscopy') {
                                echo "<tr>";
...
//                        if (isset($value) and !empty($value)) {
                            if ($key == 'csf_prelim') {
                                echo "<tr>";
                                echo "<td colspan='3' style='text-align: center'>CSF M/C/S</td>";
                                echo "</tr>";
                            }
//                        }
                    }
                    ...
                    foreach ($decode as $key => $value) {
                        if (isset($value) and !empty($value)) {
                            if ($key == 'mycology_specimen') {
                                echo "<tr>";
                                echo "<td><b> Specimen  </b></td>";
                                echo "<td colspan='2' style='text-align: center'>$value</td>";
                                echo "</tr>";
                            }
                        }
