            ...
            <div class="row">
                <div class="col-lg-6 col-md-8 col-sm-12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"> Item Assigned Reports</li>
                    </ul>
                </div>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        if (is_post()) {
                            ...
                            $assigned  = StoreDispenseHistory::find_all_assigned_by_date($startDate, $endDate);
                            if (empty($assigned)) {  ?>
                                <div class="alert alert-info alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    No Items was assigned to any dispensary for this period
                                </div>
                            <?php  } else {  ?>
                                <div class="alert alert-success alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    All Items assigned between <?php echo $start_date . " and " . $end_date ?>
                                </div>
                            <?php  } ?>
                            <div class="card">
                                <div class="body">
                                    <div class="table-responsive">
                                        <table class="table m-b-0">
                                            ...
                                            <tbody>
                                                ...
                                                <td><?php $sta = Clinic::find_by_id($h->station_id); echo $sta->name ?></td>
