...
$dispense = DispenseHistory::find_by_id($_GET['id']);
            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Drug Received Note</h2>
                        <ul class="breadcrumb">
                            ...
                            <table class="table table-bordered table-condensed table-hover">
                               ...
                               // print_r($decode);
                                ...
                                <tr>
                                    ...
                                    <th >Total Drugs Assigned</th>
                                    <td > <?php echo $dispense->item_count ?> </td>
                                </tr>
                                <tr>
                                    <th >Drugs Assigned To</th>
                                    <td > <?php $st = PharmacyStation::find_by_id($dispense->pharmacy_station_id );
                                            echo $st->name;
                                    ?>
                                     </td>
                                </tr>
                                <tr>
                                    <th >Drugs Assigned By</th>
