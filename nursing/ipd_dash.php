                                ...
                                <div class="container">
                                   ...
                                   <?php
                                        if ($_SESSION['department'] == "Nursing" && $user->role != "admin") {
                                            $nurseAllotedWard = UserMultiWards::find_by_user_id($user->id);
                                            foreach($nurseAllotedWard as $ke => $nurWardData){
                                                $wardDetail = Wards::find_by_id($nurWardData->ward_id);
                                                $bedDetail = Beds::find_by_ward_id($wardDetail->id);
                                            ...
                                            ?>
                                                <ul class="list-group ward">
                                                    <li class='list-group-item'>
                                                        <a href="wards_dr.php?ward=<?php echo $wardDetail->id ?>"><?php echo $wardDetail->ward_number ?></a>
