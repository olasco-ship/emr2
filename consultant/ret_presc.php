                    ...
                    <div class="card patients-list">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs-new2">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#All">  Returned Prescription </a></li>
                                ...
                                <div class="tab-pane table-responsive active show" id="All">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        if (is_post()) {
                                            ...
                                            <?php } } else {
                                            $drugRequests = DrugRequest::find_returned_prescription_by_sub_clinic_id($u->sub_clinic_id);
//                                                print_r($u->sub_clinic_id) ; exit();
                                            foreach($drugRequests as $request) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href='prescription.php?id=<?php echo $request->id ?>'> View Prescription </a>
                                                    </td>
