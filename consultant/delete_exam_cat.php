...
if (is_post()){
    ...
    if ((!$errorMessage) and empty($errorMessage)){
        ...
        if ($update_exam_cat->delete()){

            $done = TRUE;
            $session->message("An examination category has been deleted");
            redirect_to('examination_category.php');
        } else {
            $done = FALSE;
            $session->message("Couldn't delete an examination category");
        }
    }
}
                            ...
                            <div class="col-lg-12 col-md-12">
                                <div class="card">
                                    <div class="body">
                                        ...
                                        <h5> Delete Examination Category </h5>
                                        <br/>
