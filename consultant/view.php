    ...
    if (isset($_POST['save_drug'])) {
        ...
        if ($bill->save()) {
            foreach ($items as $item) {
                ...
                $request->test_name = $test->name;
                $request->unit = $item->quantity;
                $request->unit_price = $test->price;
                $request->total_price = $item->quantity * $test->price;
                $request->status = "REQUESTED";
                $request->receipt = "";
                $request->date = strftime("%Y-%m-%d %H:%M:%S", time());
                $request->save();
                /*
                if ($item->id == $product->id) {
                    $product->quantity = $product->quantity - $item->quantity;
            ...
            <div class="tab-pane fade" id="billings">
                <div class="clearfix">
                    ...
                    <div class="panel-group" id="accordion">
                        <?php   $bills = Bill::find_by_date_only($patient->id);
                        foreach ($bills as $r) { ?>
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="panel-title">
                                        <a data-toggle="collapse" data-parent="#accordion"
                                           href="#collapse<?php echo $r->id; ?>">
                                            <?php $d_date = date('d-M-Y', strtotime($r->date));
                                            echo $r->date_only . "<br/>";
                                             ?>
                                        </a>
                                        <a href="#accordion"
                                ...
                                <div id="collapse<?php echo $r->id; ?>" class="panel-collapse collapse">
                    ...
                    <div class="panel-group" id="accordion">
                        <?php
                              $results = Result::find_by_patient_id($patient->id);
                        foreach ($results as $r) { ?>
                            <div class="panel panel-default">
                                ...
                                <div id="collapse<?php echo $r->id; ?>" class="panel-collapse collapse">
                                    <div class="panel-body">
                                        <?php
                                        $m = TestResult::find_by_result_id($r->id);
                                        ?>
                                        <div class="row">
