...
$userSubClinic = UserSubClinic::find_by_clinic($clinic->id);
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>
                            Returned Radiology Investigation </h2>
                        <ul class="breadcrumb">
                    ...
                    <div class="card patients-list">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs-new2">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#All">  Returned Radiology Investigation </a></li>
                                ...
                                <div class="tab-pane table-responsive active show" id="All">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        if (is_post()) {
                                            ...
                                            <?php } } else {
                                                $scanRequests = ScanRequest::find_returned_investigation_by_subClinic($u->sub_clinic_id);
                                             //   $testRequests = TestRequest::find_returned_investigation();  
                                            foreach($scanRequests as $request) {
                                                ...
                                                <!--    <td><?php echo $request->not_available ?></td>  -->
                                                 ...
                                                 <td>
                                                    <a href='investigation_scan.php?id=<?php echo $request->id ?>'> View Investigation </a>
                                                </td>
