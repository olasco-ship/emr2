            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>  Patients on Waiting List</h2>
                        <ul class="breadcrumb">
...
<!--            <h6><a style="font-size: larger" href="clinic.php">&laquo;Back</a></h6>-->
                                            ...
                                            foreach($patients as $patient) {   ?>
                                                <tr>
                                                    ...
                                                    <td><a href='stage.php?id=<?php echo $patient->id ?>'><?php echo $patient->folder_number ?></a></td>
                                                     <td><a href='dashboard.php?id=<?php echo $patient->id ?>'><?php echo $patient->full_name() ?></a></td>
...
/*                                            $sql  = "SELECT * FROM patients WHERE status = 'open' ORDER BY first_name  ";
                                            ...
                                            foreach($waitingConsultation as $waiting)  {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href='dashboard.php?id=<?php echo $waiting->id ?>'><?php echo $patient->full_name() ?></a></td>
                                                    <!--<td><?php /*echo $patient->full_name() */?></td>-->
