...
if (is_post()) {
    ...
    $drugRequests->status = "REJECTED";
    $drugRequests->save();

//    $eachDrugs                  = EachDrug::find_by_id($drugRequests->id);
    $eachDrugs                  = EachDrug::find_all_awaiting_requests($drugRequests->id);
    foreach ($eachDrugs as $each){
...
//    $patient = Patient::find_by_id($waiting_list->patient_id);
    ...
    $drugRequest->waiting_list_id = $drugRequests->waiting_list_id;
    $drugRequest->sub_clinic_id   = $drugRequests->sub_clinic_id;
    ...
    $drugRequest->pharm_com       = $drugRequests->pharm_com;
    ...
    if ($drugRequest->save()) {
        ...
        redirect_to("prescription.php?id=$drugRequest->id");
    }
                    ...
                    <div class="body">
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-12 col-md-12">
                                ...
                                <a href="add_new_drug.php?id=<?php echo $drugRequest->id ?>">Back</a>
