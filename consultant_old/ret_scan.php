                    ...
                    <div class="card patients-list">
                        ...
                        <div class="body">
                            ...
                            <ul class="nav nav-tabs-new2">
                                <li class="nav-item"><a class="nav-link active show" data-toggle="tab" href="#All">  Returned Scan/Ultrasound </a></li>
                                ...
                                <div class="tab-pane table-responsive active show" id="All">
                                    <table class="table m-b-0 table-hover">
                                        ...
                                        if (is_post()) {
                                            ...
                                            <?php } } else {
                                            $testRequests = ScanRequest::find_returned_investigation_by_subClinic($u->sub_clinic_id);
