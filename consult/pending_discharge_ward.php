            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <h2> All Pending Discharge By Ward </h2>
                        ...
                        if (is_post()) {
                            ...
                            $admission = ReferAdmission::find_pending_discharge_by_ward($ward, $start_date, $end_date);

                            if (empty($admission)) {  ?>
                                <div class="alert alert-info alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    No pending discharge for <?php echo $w->ward_number ?> between <?php echo $start_date . " and " . $end_date  ?>
                                </div>
                            <?php  } else {  ?>
