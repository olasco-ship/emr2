            ...
            <div class="col-lg-12 col-md-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <h2> All Hospital Visit By Consultant Report </h2>
                        ...
                        if (is_post()) {
                            ...
                            $waiiting = WaitingList::find_all_done_by_consultant($consultant, $startDate, $endDate);
                            if (empty($waiiting)) {  ?>
                                <div class="alert alert-info alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    No hospital visit for this period for <?php echo $consultant ?>
                                </div>
                            <?php  } else {  ?>
                                <div class="alert alert-success alert-dismissible" role="alert" style="width: 800px">
                                    <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                    All records of Hospital visit between <?php echo $start_date . " and " . $end_date ." for ". $consultant ?>
                                </div>
                            <?php  } ?>
                            <div class="card">
                                <div class="body">
