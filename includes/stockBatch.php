...
class StockBatch extends DatabaseObject
{
    public static $table_name = "stockBatch";
    ...
    public static function find_product_quantity($product_id){
        return static::find_by_sql("SELECT quantity FROM " .static::$table_name. " WHERE product_id = $product_id " . " ORDER BY exp_date LIMIT 1" );
    }
    ...
    public static function create_table(){
        $sql = 'CREATE TABLE IF NOT EXISTS ' . StockBatch::$table_name . '(' .
