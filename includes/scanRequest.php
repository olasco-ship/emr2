...
class ScanRequest extends DatabaseObject
{
    public static $table_name = "scan_request";
    protected static $db_fields = array('id', 'sync', 'radWalkIn_id', 'waiting_list_id', 'sub_clinic_id', 'ref_adm_id', 'ward_id', 'bill_id', 'patient_id', 'consultant', 'scan_no', 'not_done', 'doc_com', 'scan_com',
        'status', 'receipt', 'date');
	...
	public static function find_requests_by_patientIdForBilledScan( $patient_id){
    ...
    public static function find_booked(){
        return static::find_by_sql("SELECT * FROM " .static::$table_name. " WHERE status = 'booked' ORDER BY date DESC" );
    }
    ...
    public static function count_returned_scan($sub_clinic_id){
        global $database;
    ...
    public static function create_table(){
        $sql = 'CREATE TABLE IF NOT EXISTS ' . ScanRequest::$table_name . '(' .
            'id INT(11) NOT NULL AUTO_INCREMENT, ' .
            'sync VARCHAR(20) NOT NULL, ' .
            'radWalkIn_id INT(11) NOT NULL, ' .  
