...
class DrugServices extends DatabaseObject {

    protected static $table_name = "drug_service";
    protected static $db_fields = array('id', 'sync', 'bill_id', 'drug_request_id', 'ward_clinic', 'services', 'unit', 
     'status', 'date');
    ...
    public static function find_dispensed_by_date($startDate, $endDate){
        return static::find_by_sql("SELECT * FROM " .static::$table_name. " WHERE status = 'DISPENSED' AND date BETWEEN '$startDate' AND '$endDate' ORDER BY date DESC " );
    }
    ...
    public static function create_table(){
        $sql = 'CREATE TABLE IF NOT EXISTS ' . DrugServices::$table_name . '(' .
            ...
            'PRIMARY KEY(id))';
            DrugServices::run_script($sql);
    }


}

DrugServices::create_table();