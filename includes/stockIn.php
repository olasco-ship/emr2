...
class StockIn extends DatabaseObject
{

    protected static $table_name = "stockIn";
    ...
    {
        $sql = 'CREATE TABLE IF NOT EXISTS ' . StockIn::$table_name . '(' .
            ...
            'PRIMARY KEY(id))';
        StockIn::run_script($sql);

    }
}

StockIn::create_table();
