...
class LabWalkIn extends DatabaseObject {

    protected static $table_name = "labWalkIn";
    ...
    public static function create_table(){
        $sql = 'CREATE TABLE IF NOT EXISTS ' . LabWalkIn::$table_name . '(' .
            ...
            'PRIMARY KEY(id))';
            LabWalkIn::run_script($sql);
    }


}

LabWalkIn::create_table();