...
class RadioServices extends DatabaseObject {

    protected static $table_name = "radio_service";
    protected static $db_fields = array('id', 'sync', 'bill_id', 'scan_request_id', 'ward_clinic', 'services', 'unit', 
     'status', 'date');
    ...
    public static function create_table(){
        $sql = 'CREATE TABLE IF NOT EXISTS ' . RadioServices::$table_name . '(' .
            ...
            'PRIMARY KEY(id))';
            RadioServices::run_script($sql);
    }


}

RadioServices::create_table();