...
$validity = checkValidity($enrollee->exp_date);

if($validity == 'Expired'){
    redirect_to('check.php');
}

 //echo $enrollee->full_name(); exit;
...
/*    if (empty($_POST['folder_number'])) {
        $errFolderNumber = "Folder Number is Required";
        $errMessage .= $errFolderNumber . "<br/>";
    } else {
        $folder_number = test_input($_POST['folder_number']);
    }*/

    if (empty($_POST['hosp_number'])) {
        $errFolderNumber = "Hospital Name  is Required";
        $errMessage .= $errFolderNumber . "<br/>";
    } else {
        $folder_number = test_input($_POST['hosp_number']);
        $pat = Patient::find_by_number($folder_number);

        if (isset($pat) && !empty($pat)) {
            $errFolderNumber = "Hospital Number already exists";
            $errMessage .= $errFolderNumber . "<br/>";
        }
    }
    ...
    if ((!$errMessage) and (empty($errMessage))) {
        ...
        if ($patient->save()) {
            ...
            if ($patientSubClinic->save()){
                ...
                $newEnrolleePatient                = new EnrolleePatient();
                $newEnrolleePatient->sync          = "off";
                $newEnrolleePatient->enrollee_id   = $enrollee->id;
                $newEnrolleePatient->patient_id    = $patient->id;
                $newEnrolleePatient->nhis_number   = $enrollee->nhis_number;
                $newEnrolleePatient->folder_number = $patient->folder_number;
                $newEnrolleePatient->date          = strftime("%Y-%m-%d %H:%M:%S", time());
                $newEnrolleePatient->save();
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i
                                        class="fa fa-arrow-left"></i></a> Patient Registration </h2>
                        <ul class="breadcrumb">
                        ...
                        <div class="body">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"  name="first_name" value="<?php echo $enrollee->first_name ?>" required>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>Last Name</label>
                                        <input type="text" class="form-control" name="last_name" value="<?php echo $enrollee->last_name ?>" required>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="hosp_number" id="hosp_number" value="<?php echo $folder_number ?>" required>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="dob" id="dob" placeholder="dd-mm-yyyy" value="<?php echo $enrollee->dob ?>" required>
                                    </div>
                                </div>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <label>LGA</label>
                                        <input type="text" class="form-control" name="lga" id="lga" value="<?php echo $lga ?>" >
                                    </div>
                                    <!--
                                    <div class="form-group">
                                        <label>LGA</label>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="phone_number" required value="<?php echo $phone_number ?>" >
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    $('#hosp_number').change(function () {
        ...
        folder ?
            $.post('../patient/check_folder.php', {folder_number: folder}, function (data) {
