                    ...
                    <div class="card">
                        ...
                        <div class="body">
                            ...
                            if (is_post()) {
                                ...
                                //clinic id has to be in patient table

                                //  $patClinic = PatientSubClinic::find_pat_and_subclinic($sub_clinic_id);
                                $findPatient = Patient::find_by_id($_GET['id']);
                                $subClinic = SubClinic::find_by_id($findPatient->sub_clinic_id);
                                //$clinics = Clinic::find_by_id($subClinic->clinic_id);

                                $patSubClinic = PatientSubClinic::find_by_clinic_date($sub_clinic_id, $startDate, $endDate);
                                foreach ($patSubClinic as $psc){

                                }
                                $patie = Patient::find_by_id($psc->patient_id);

                                $patient = Patient::find_by_sub_clinic_reg_date($sub_clinic_id, $startDate, $endDate);
                                    ...
                                    <div class="body">
                                        <div class="table-responsive">
                                            <table class="table m-b-0">
                                                ...
                                                <?php
                                                if (is_post()) {
                                                    $patSubClinics = PatientSubClinic::find_by_clinic($clinics->id);
                                                    foreach ($patSubClinics as $patSubClinic) {
                                                        $pat = Patient::find_by_id($patSubClinic->patient_id);
                                                        ?>
                                                        <tr>
