...
<div class="body">
    ...
    <form action="studies_search.php" method="POST">
    ...
    <div class="row clearfix">
        <form method="post" action="code.php">
            ...
            <div class="row">
                <div class="col-lg-12">
                    <p>This is to certify that I have examined the above candidate and found him/her to be physically and mentally for the further studies
            ...
            <div class="row">
                ...
                <div class="col-md-7 mb-4">
                    <input type="text" name="hepatitis_bsa" class="form-control" value="<?php $data->HBsAg ?>" required/>
                </div>
            </div>
          ...
          <!--   <div class="row">
                ...
                <div class="col-md-7 mb-4">
                    <input type="text" name="hcv" class="form-control" value="<?php $data->HCV ?>"required/>
                </div>
            </div>  -->
            ...
            <div class="row">
                <div class="offset-1 col-md-7">
                    <button type="submit" name="stu_submit_btn" class="btn btn-info">Save</button>
                </div>
                <div class="col-md-4">
                </div>
            </div>
