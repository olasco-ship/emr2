...
$user = User::find_by_id($session->user_id);
   ...
   // $search = $_POST['search_id'];
    ...
    //$patient = Patient::find_by_number_and_result($search);
...
<?php if (is_post()){//if ($_SERVER["REQUEST_METHOD"] == 'POST') {
    ...
    if (empty($patient)) {
        ...
        <form method="post" action="code.php">
            ...
            <div class="row">
                <div class="offset-1 col-md-8">
                    <input type="text" name="electrocardiogram" class="form-control" value="<?php echo $gen->ECG ?>">
                </div>
            ...
            <div class="row">
             ...
             <?php 
                  // $decoded =  json_decode($patient->resultData));
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <textarea name="micro_para" class="form-control" value = ""></textarea>
                </div>
            </div>
            ...
            <div class="row">
                <div class="offset-1 col-md-7">
                    <button type="submit" name="submit_pilg_btn" class="btn btn-info">Save</button>
                </div>
                <div class="col-md-4">
                </div>
            </div>
