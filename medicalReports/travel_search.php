    ...
    <div class="row clearfix">
        <form method="post" action="code.php">
            ...
            <div class="row form-group">
                ...
                <div class="col-md-3">
                    <input type="text" name="bg" class="form-control" id="pcv" value="<?php echo $data->BloodGroup ?>">
                </div>
                ...
                <div class="col-md-3">
                    <input type="text" name="genotype" class="form-control" id="bg" value="<?php echo $data->HbGenotype ?>">
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-7 mb-4">
                    <input type="text" name="hepatitis_bsa" class="form-control" value="<?php echo $data->HBsAg ?>" required/>
                </div>
            </div>
            ...
            <div class="row">
                <div class="offset-1 col-md-7">
                    <button type="submit" name="travel_submit_btn" class="btn btn-info">Save</button>
                </div>
                <div class="col-md-4">
                </div>
            </div>
